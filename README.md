...
- Port 6379 should be free, as it will be used by redis
- Update environment variables [CELERY_BROKER, CELERY_BACKEND] to services:
  - appseed-app 
  - celery 
- Update path to custom scripts at core.settings.CELERY_SCRIPTS_DIR.
- Update path to execution logs at core.settings.CELERY_LOGS_DIR.
- Update result expiration time at core.settings.CELERY_RESULT_EXPIRES
